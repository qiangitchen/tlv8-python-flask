...
;(function() {
  ...
  SVG.isIE = function(){
	  ...
	  return (nuseragent.indexOf("MSIE")>0) || (nuseragent.indexOf("Firefox")<0 && nuseragent.indexOf("Safari")<0 
	  		&& nuseragent.indexOf("Camino")<0 && nuseragent.indexOf("Gecko/")<0
	  		&& nuseragent.indexOf("Chrome")<0);
  };
  
  SVG.getOSInfo = function(){
	  var sUserAgent = navigator.userAgent;
	  if (SVG.isWinOS()) {
	    var isWin2K = sUserAgent.indexOf("Windows NT 5.0") > -1 || sUserAgent.indexOf("Windows 2000") > -1;
	    if (isWin2K) return {name:"Windows2000",version:5.0};
	    var isWinXP = sUserAgent.indexOf("Windows NT 5.1") > -1 || sUserAgent.indexOf("Windows XP") > -1;
	    if (isWinXP) return {name:"WindowsXP",version:5.1};
	    var isWin2003 = sUserAgent.indexOf("Windows NT 5.2") > -1 || sUserAgent.indexOf("Windows 2003") > -1;
	    if (isWin2003) return {name:"Windows2003",version:5.2};
	    var isWinVista= sUserAgent.indexOf("Windows NT 6.0") > -1 || sUserAgent.indexOf("Windows Vista") > -1;
	    if (isWinVista) return {name:"Windows Vista",version:6.0};
	    var isWin7 = sUserAgent.indexOf("Windows NT 6.1") > -1 || sUserAgent.indexOf("Windows 7") > -1;
	    if (isWin7) return {name:"Windows7",version:6.1};
	    var isWin8 = sUserAgent.indexOf("Windows NT 6.2") > -1 || sUserAgent.indexOf("Windows 8") > -1;
	    if (isWin8) return {name:"Windows8",version:6.2};
	    var isWin10 = sUserAgent.indexOf("Windows NT 10") > -1 || sUserAgent.indexOf("Windows 10") > -1;
	    if (isWin10) return {name:"Windows10",version:10.0};
	  }
	  return {name:navigator.platform,version:10.1};
  };
